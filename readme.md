...
git clone -b 0.8.1 --single-branch --depth 1 https://github.com/footworkjs/footworkjs.com.git 0.8.1
git clone -b 1.0.0 --single-branch --depth 1 https://github.com/footworkjs/footworkjs.com.git 1.0.0
```
