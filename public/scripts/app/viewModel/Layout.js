  ...
  function( fw, _ ) {
    return fw.viewModel.create({
      ...
      initialize: function() {
        ...
        // dont turn on animations until we see a valid value for the pane width
        this.loadingLayout = fw.observable(true);
        this.paneWidth.subscribe(function(width) {
        ...
        this.layoutTransitionsDisabled = fw.computed(function() {
          return this.loadingLayout() || this.transitionsDisabled() || this.controlEnabled() || this.configReflowing();
        }, this);
        ...
        this.mainRouterOutlet = fw.observable().receiveFrom('MainRouter', 'mainContent').subscribe(function() {
